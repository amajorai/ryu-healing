<p align="center">
  <picture>
    ...
    <img src="./icon-light.png" alt="Self-Healing" width="144" />
  </picture>
</p>
...
**App:** [Install](ryu://apps/@ryu/healing) (opens the Ryu desktop app and asks you to confirm)

**CLI:**

```bash
ryu apps add @ryu/healing
```

**Crate:**

```bash
cargo install ryu-healing
```
